...
import type { Patient as ViewPatient } from '@/types/patient';

export function fromDomainPatient(patient: DomainPatient): ViewPatient {
  return {
    id: patient.id,
...
export function toDomainPatientCreateInput(patient: Omit<ViewPatient, 'id' | 'createdAt' | 'updatedAt'>): PatientCreateInput {
  return {
    registrationNumber: patient.registrationNumber,
    name: patient.name,
    birthDate: patient.birthDate,
...
export function toDomainPatientUpdateInput(updates: Partial<ViewPatient>): PatientUpdateInput {
  return {
